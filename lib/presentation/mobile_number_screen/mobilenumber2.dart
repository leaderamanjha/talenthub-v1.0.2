...
class MobileNumber2Screen extends StatelessWidget {
  MobileNumber2Screen({Key? key}) : super(key: key);
            ...
            child: Column(
              ...
              children: [
                Padding(
                  ...
                  child: Text("Get Started", style: CustomTextStyles.bodyMedium14_1),
                ),
  ...
  onTapContinue(BuildContext context) async {
    if (_formKey.currentState?.validate() ?? false) {
      ...
      final String apiUrl = "http://localhost:5000/api/user/signup";
      ...
      try {
        ...
        if (response.statusCode == 200) {
          // Successful response, parse the data and proceed to OTP verification screen
          final Map<String, dynamic> data = json.decode(response.body);
          final String userId = data['userId']; // Assuming your backend sends userId
          Navigator.pushNamed(context, AppRoutes.otpVerificationScreen, arguments: userId);
        } else {
          // Handle error
