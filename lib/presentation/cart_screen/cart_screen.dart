            ...
            Container(
                ...
                child: Stack(alignment: Alignment.bottomLeft, children: [
                  ...
                  CustomImageView(
                      ...
                      margin:
                          EdgeInsets.only(top: 9.v, right: 26.h, bottom: 7.v))
                ]))
          ]),
      body: Container(
          ...
          child:
                      ...
                      Padding(
                          ...
                          child: Column(
                              ...
                              children: [
                                ...
                                Padding(
                                    padding:
                                        EdgeInsets.only(top: 11.v, right: 33.h),
                                    child: Text("₹30",
            ...
            Align(
                ...
                child: Padding(
                    padding:
                        EdgeInsets.only(left: 19.h, top: 26.v, right: 11.h),
                    child: Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          Padding(
            ...
            Container(
                ...
                child: RichText(
                    text: TextSpan(children: [
                      ...
                      TextSpan(text: "₹30", style: theme.textTheme.bodyLarge)
                    ]),
                    textAlign: TextAlign.left))
          ])),
    ));
